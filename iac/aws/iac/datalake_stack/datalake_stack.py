...
class IotDataLakeStack(Stack):

    def __init__(self, scope: Construct, construct_id: str, 
                 bucket_name: str,
                 target_buckets: List[BucketAttributes], deploy_replication: bool,
                 application_ci: str,
                 **kwargs) -> None:
        ...
        self.datalake_bucket = aws_s3.Bucket(self, "iotDatalakeBucket",
        ...
        if deploy_replication:
            cfn_bucket: CfnBucket = self.datalake_bucket.node.default_child
        ...
        replication_role.add_to_policy(
            aws_iam.PolicyStatement(
                ...
                resources=[
                    self.datalake_bucket.arn_for_objects("*"),
                ]
            ))
        replication_role.add_to_policy(
            aws_iam.PolicyStatement(
